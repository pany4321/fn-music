...
open class AbsoluteContinuousRoundedRectangle(
    ...
    open val continuity: Continuity = Continuity.Companion.Default
) : CornerBasedShape(
    topStart = topLeft,
    topEnd = topRight,
...
@Stable
fun AbsoluteContinuousRectangle(continuity: Continuity = Continuity.Companion.Default): AbsoluteContinuousRoundedRectangle =
    AbsoluteContinuousRectangleImpl(continuity)

@Immutable
private data class AbsoluteContinuousRectangleImpl(
    override val continuity: Continuity = Continuity.Companion.Default
) : AbsoluteContinuousRoundedRectangle(
...
@Suppress("FunctionName")
@Stable
fun AbsoluteContinuousCapsule(continuity: Continuity = Continuity.Companion.Default): AbsoluteContinuousRoundedRectangle =
...
fun AbsoluteContinuousRoundedRectangle(
    corner: CornerSize,
    continuity: Continuity = Continuity.Companion.Default
): AbsoluteContinuousRoundedRectangle =
    AbsoluteContinuousRoundedRectangle(
        topLeft = corner,
        topRight = corner,
